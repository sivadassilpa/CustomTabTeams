...
export default class GroupClaims extends React.Component<IClaimsProps, {}> {
  ...
  public render(): React.ReactElement<IClaimsProps> {
    ...
    return (
      <div className={styles.containerDiv}>
        <Button variant="contained" style={{width:"40%", backgroundColor:"#464775", marginLeft:"30%", marginRight:"30%", float:"left", textTransform: 'capitalize', fontSize:"10pt", fontWeight:700, color:"white"}}>Authorize Claims </Button>
